...
## United States Data
  ...
  One takeaway from the maps above is that the United States tend to have the funding and the drive to record large quantities of data about species diversity. Let's take a closer look at some differences within the United States.
...
```
  ...
  This plot shows the total species in 
